...
-   `sads::fitls()` utilse `mle2()` pour maximiser la vraisemblance de `sads::dls()` (la densité de probabilité de la log-série). La valeur de départ est par défaut l'estimation ponctuelle.
